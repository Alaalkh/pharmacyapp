...
class UpdateMed extends StatefulWidget {
  ...
  const UpdateMed(
      ...
      : super(key: key);
  @override
  State<UpdateMed> createState() => _UpdateMedPageState();
}

class _UpdateMedPageState extends State<UpdateMed> {
  ...
  void initState() {
    ...
    nameController.text = widget.Medname;
    dosageController.text = widget.dose;
    timeController.text = widget.time;
    typeController.text = widget.Medtype;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<DbController>(builder: (context, controller, child) {
        return Column(
          ...
          children: [
            ...
            Center(
              child: Padding(
                ...
                UPDATE "medicine" SET
                medname = "${nameController.text}",dose = "${dosageController.text}",medtime = "${timeController.text}",medtype = "${typeController.text}"
                WHERE id = "${widget.id}"
                '''));
